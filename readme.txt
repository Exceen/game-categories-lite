...
Changelog
v1.8:
[+]Move to gclite_filters.txt for hiding categories & apps with ms0:/ & ef0:/ specification support and filepaths for hiding apps. (See example gclite_filters.txt a few paragraphs above.)
